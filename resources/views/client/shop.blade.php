                ...
                <div class="col-md-10 mb-5 text-center">
                    <ul class="product-category">
                        ...
                        @foreach ($categories as $category)
                            <li><a href="/view_by_cat/{{ $category->category_name }}"
                                    class="{{ request()->is('view_by_cat/' . $category->category_name) ? 'active' : '' }}">{{ $category->category_name }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                        ...
                        <div class="product">
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                ...
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price"><span
                                                class="mr-2 price-dc">{{ $product->product_price }}</span><span
